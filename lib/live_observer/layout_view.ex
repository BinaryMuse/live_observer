defmodule LiveObserver.LayoutView do
  @moduledoc false
  use LiveObserver.Web, :html
  ...
  defp asset_path(conn, asset) when asset in [:css, :js] do
    hash = LiveObserver.Assets.current_hash(asset)

    if function_exported?(conn.private.phoenix_router, :__live_observer_prefix__, 0) do
      prefix = conn.private.phoenix_router.__live_observer_prefix__()
